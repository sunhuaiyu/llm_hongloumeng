...
## Outputs
- Summary JSON: `artifacts/contamination_checks_text2vec_zh/summary.json`
- Null histogram figure: `artifacts/contamination_checks_text2vec_zh/null_split_hist_masked_embedding.png`