...
Per-model outputs:
- `artifacts/embedding_cluster_bge_small_zh/report.md`
- `artifacts/embedding_cluster_e5_small/report.md`
- `artifacts/embedding_cluster_text2vec_zh/report.md`
...
Primary outputs:
- `artifacts/contamination_checks/report.md`
- `artifacts/contamination_checks_bge_small_zh/report.md`
- `artifacts/contamination_checks_text2vec_zh/report.md`
- `artifacts/contamination_checks_model_comparison.md`

### D1. Corpus-Only Check (No Embedding Model)
From `artifacts/contamination_checks/report.md`:
