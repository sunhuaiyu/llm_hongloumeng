...
## Outputs
- Summary JSON: `artifacts/07_contamination_checks/bge_small_zh/summary.json`
- Null histogram figure: `artifacts/07_contamination_checks/bge_small_zh/null_split_hist_masked_embedding.png`